...
public class EX5_1 extends JFrame implements ActionListener { // 시작이 X로 하던 O로 하던 상관없는 지, 예시와 같이 label X와 O의 크기는 커야하는 지
	// 누른거 또 누르면 변환 없어야하고 o, x 왔다갔다 하면서 되어야함, 교수님이 빙고 처리는 할 필요없다 하심
